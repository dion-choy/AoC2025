...
let part1 input = 
    let check_num num_str =
        if String.length num_str mod 2 = 0 then
            if (String.sub num_str 0 (String.length num_str / 2)) =
                (String.sub num_str (String.length num_str / 2) (String.length num_str / 2))
...
let part2 input = 
    ...
    let rec split_str num str =
        ...
        else String.sub str 0 num :: split_str num (String.sub str num (String.length str - num)) in
